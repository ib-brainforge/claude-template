...
- Core packages (mf-packages) must be published by CI/CD before use
- PR-based versions available: `0.1.X-pr.42.abc1234` with dist-tag `pr-42`
- Install PR version: `pnpm add @bf/security@pr-42`

**API Clients:**
- Backend API clients are generated by CI/CD from OpenAPI specs
- Packages: `@bf/identity-management-client`, `@bf/asset-backend-client`, etc.
- If backend API changes, wait for client regeneration before updating frontend

**Cross-Repo Development:**
1. Core package PR created → CI publishes PR version
2. Install PR version in frontend: `pnpm add @bf/package@0.1.X-pr.42.abc1234`
3. After core package merges → update to stable version
